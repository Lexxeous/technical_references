; nasm -f elf64 dec_addsub_bin.asm && gcc -static -o dec_addsub_bin dec_addsub_bin.o -lm
...
; This program will take two decimal inputs, and print the binary results of thier addition and subtraction.
...
.top:
	...
	shr rax, 2
	mov rdi, 1
	lea rsi, [bin_nyb + rax] ; move the address of the rax-th nybble string from <bin_nyb> data to rsi
	mov rdx, 4
	mov rax, 1
